...
-- Mevcut hotel_* tablolarını telefondaki panele bağlar.
...
begin
  ...
  if v_hotel_id is null then
    raise exception 'Bu kullanıcı bir otele bağlanmamış';
  end if;

  select jsonb_build_object(
    'hotel', jsonb_build_object('id', v_hotel_id, 'name', coalesce(v_hotel_name, 'Babacan Otel')),
    'lastSync', greatest(
